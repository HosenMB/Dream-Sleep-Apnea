...
- **Research team** at Charles Sturt University and collaborating institutions
- **Open-source community** for TensorFlow, Keras, and scientific Python libraries

---

## 📧 Contact

**Corresponding Author**: Mohammad Ali Moni  
**Email**: m.moni@uq.edu.au  
**Institution**: Artificial Intelligence and Cyber Futures Institute, Charles Sturt University
...
[![Star History Chart](https://api.star-history.com/svg?repos=yourusername/dream-apnea-detection&type=Date)](https://star-history.com/#yourusername/dream-apnea-detection&Date)
...
### 💤 Advancing Sleep Health Through AI

**DREAM** is committed to making sleep apnea detection accessible, accurate, and explainable.

[Paper](https://ssrn.com/abstract=5139337) • [Dataset](https://physionet.org/content/apnea-ecg/1.0.0/) • [Documentation](#) • [Issues](https://github.com/yourusername/dream-apnea-detection/issues)
